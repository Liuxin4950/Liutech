...
-- 创建测试会话
-- INSERT INTO ai_conversation (user_id, type, title, status, message_count, last_message_at)
-- VALUES ('1', 'general', '测试会话', 0, 0, NOW());

-- 创建测试消息
-- INSERT INTO ai_chat_message (conversation_id, user_id, role, content, seq_no, status)
-- VALUES (1, '1', 'user', '你好', 1, 1),
--        (1, '1', 'assistant', '你好！我是AI助手', 2, 1);
