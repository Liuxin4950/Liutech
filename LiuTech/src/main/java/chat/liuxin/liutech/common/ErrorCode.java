...
public enum ErrorCode {
     ...
     * 账户被锁定 - 登录失败次数过多
     */
    ACCOUNT_LOCKED(1008, "登录失败次数过多，账户已被锁定"),
     ...
     * 分类创建失败
     */
    CATEGORY_CREATE_FAILED(1107, "分类创建失败"),
    
    /**
     * 标签创建失败
     */
    TAG_CREATE_FAILED(1108, "标签创建失败"),
    
    /**
     * 分类名称已存在
     */
    CATEGORY_NAME_EXISTS(1109, "分类名称已存在"),
    
    /**
     * 标签名称已存在
     */
    TAG_NAME_EXISTS(1110, "标签名称已存在"),
    
    /**
     * 标签搜索失败
     */
    TAG_SEARCH_FAILED(1111, "标签搜索失败"),

    /**
     * 文章系列不存在
     */
    SERIES_NOT_FOUND(1112, "文章系列不存在"),

    /**
     * 文章系列名称已存在
     */
    SERIES_NAME_EXISTS(1113, "系列名称已存在"),
     ...
     * 留言提交过于频繁
     */
    MESSAGE_TOO_FREQUENT(1501, "留言提交过于频繁，请稍后再试"),

    /**
     * 留言内容包含敏感词
     */
    MESSAGE_CONTENT_INVALID(1502, "留言内容不符合规范"),
