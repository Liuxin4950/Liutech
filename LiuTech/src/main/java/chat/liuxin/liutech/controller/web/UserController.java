...
public class UserController {
     ...
     */
    @GetMapping
    public Result<?> getUsers(@RequestParam(required = false) Long id,
     ...
     */
    @PutMapping("/{id}")
    public Result<String> updateUser(@PathVariable Long id, @Valid @RequestBody Users user) {
