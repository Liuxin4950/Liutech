...
public interface TagsMapper extends BaseMapper<Tags> {
     ...
     * @return 标签列表
     */
    List<TagResp> selectTagsWithPostCount();
     ...
     * @return 标签列表
     */
    List<TagResp> selectTagsByPostId(@Param("postId") Long postId);
     ...
     * @return 热门标签列表
     */
    List<TagResp> selectHotTags(@Param("limit") Integer limit);
     ...
     * @return 标签详情
     */
    TagResp selectTagByIdWithPostCount(@Param("id") Long id);
     ...
     * @return 标签列表
     */
    List<TagResp> selectTagsByName(@Param("name") String name);
