...
public interface AiChatService {
     ...
     */
    ChatResponse processChat(ChatRequest request, Long userId, String role);
     ...
     */
    SseEmitter processStreamChat(ChatRequest request, Long userId, String role);
     ...
     */
    ChatResponse processWriting(ChatRequest request, Long userId, String role);

    /**
     * 写作助手流式调用,SSE 输出但不落库,同样注册 WritingTools。
     */
    SseEmitter processWritingStream(ChatRequest request, Long userId, String role);
}