---
name: prd-workflow
description: 通用 PRD 工作流。仅当用户明确要求“生成需求PRD”“生成实现PRD”“先设计方案”“实现前规划”“审查这个需求PRD”“根据这个需求设计实现方案”时使用。日常交流、概念解释、头脑风暴不触发本 skill；用户直接说“帮我实现”“开始开发”“修复 bug”时，先按项目规则做变更分级，而不是默认进入 PRD skill。本 skill 只推进到实现 PRD，不负责编码交付；编码交付使用 delivery-workflow。若项目存在 .codex/project-adapter.md，必须按该适配文件使用项目目录、模块和验证约定。
---
